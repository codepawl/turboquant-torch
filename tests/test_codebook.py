...
class TestCodebook:
    ...
    def test_scaling_by_dim(self):
        ...
        cb64 = get_codebook(2, dim=64)
        cb256 = get_codebook(2, dim=256)
        # Centroids should scale as 1/sqrt(d)
        ratio = cb64.centroids[-1] / cb256.centroids[-1]
        expected = (256 / 64) ** 0.5  # 2.0
